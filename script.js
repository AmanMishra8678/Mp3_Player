document.addEventListener("DOMContentLoaded", function () {
    ...
    // Array of Track URLs
    const trackList = [
      "audio/Yaari-Nikk.mp3",
      "audio/Sawarne-Lage(PaglaSongs).mp3",
      "audio/Pyaar-Karte-Ho-Na(PaglaSongs).mp3",
      "audio/Kali-Kali-Zulfon-Ke-Phande(PaglaSongs).mp3",
      "audio/Khushi-Jab-Bhi-Teri(PaglaSongs).mp3",
    ...
    const albumPhotos = [
      "images/Screenshot 2024-01-17 202528.png",
